...
class MCPToolDefinitions:
    ...
    @staticmethod
    def get_code_implementation_tools_with_references() -> List[Dict[str, Any]]:
        """Get code implementation tools plus optional reference index search."""
        return [
            MCPToolDefinitions._get_write_file_tool(),
    ...
    def get_available_tool_sets() -> Dict[str, str]:
        ...
        return {
            ...
            "code_implementation_with_references": "Code implementation tool set with optional reference index search",
            # 可以在这里添加更多工具集
    ...
    def get_tool_set(tool_set_name: str) -> List[Dict[str, Any]]:
        ...
        tool_sets = {
            ...
            "code_implementation_with_references": MCPToolDefinitions.get_code_implementation_tools_with_references(),
        }

...
def read_long_description():
    try:
        ...
        return "DeepRepro: deep-planning multi-agent harness for paper-to-code reproduction"
...
setuptools.setup(
    ...
    description="Deep-planning multi-agent harness for paper-to-code reproduction",
    long_description=long_description,
    long_description_content_type="text/markdown",
    packages=setuptools.find_packages(
        exclude=("tests*", "docs*", ".history*", ".git*", ".ruff_cache*")
    ),
    py_modules=["deeprepro"],
    classifiers=[

"""
LLM utility functions for DeepRepro.
...
def get_default_models(config_path: str = "mcp_agent.config.yaml"):
    ...
    try:
        if os.path.exists(config_path):
            ...
            google_subplan = google_config.get("subplan_model", google_implementation)
            # Anthropic
            ...
            anthropic_subplan = anthropic_config.get(
                "subplan_model", anthropic_implementation
            )
            # OpenAI
            ...
            openai_subplan = openai_config.get("subplan_model", openai_implementation)
